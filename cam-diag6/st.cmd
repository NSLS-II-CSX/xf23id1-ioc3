...
epicsEnvSet("PREFIX", "XF:23ID1-BI{Diag:6-Cam:1}"
...
prosilicaConfig("$(PORT)", "10.23.1.28", 50, 0, 0, 0, 10)
...
dbLoadRecords("$(ADCORE)/db/NDStdArrays.template", "P=$(PREFIX),R=image1:,PORT=Image1,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),TYPE=Int16,FTVL=SHORT,NELEMENTS=6000000")

# Load all other plugins using commonPlugins.cmd
< $(ADCORE)/iocBoot/commonPlugins.cmd

dbLoadRecords("/epics/iocs/cam-diag6/FeedbackStats.template", "P=$(PREFIX),R=Stats1:, PORT=STATS1,ADDR=0,TIMEOUT=1,HIST_SIZE=256,XSIZE=$(XSIZE),YSIZE=$(YSIZE),NCHANS=$(NCHANS),NDARRAY_PORT=$(PORT)")
...
dbl > /cf-update/xf23id1-ioc3.cam-diag6.dbl
