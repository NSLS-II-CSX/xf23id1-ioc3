...
pmacAsynIPConfigure("P0","xf23id1-mc11:1025")
...
#drvAsynMotorConfigure("motor", "pmacAsynMotor", 1, 8)
...
dbLoadRecords("db/asynComm.db","P=XF:23ID1-CT{MC:11},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:23ID1-CT,PMAC=MC:11,VERSION=1,PLC=5,PORT=P0,NAXES=5")
...
dbLoadRecords("$(EPICS_BASE)/db/iocAdminSoft.db","IOC=XF:23ID1-CT{IOC:MC11}")
...
dbl > "/cf-update/xf23id1-ioc3.mc11.dbl"
