...
{
    const char *bldTop = "/epics/iocs/simmotor";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"mtrSim_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    mtrSim_registerRecordDeviceDriver(*iocshPpdbbase);
}
