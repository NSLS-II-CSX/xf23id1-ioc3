...
/* Generated from ../O.Common/K2611.dbd */
...
static const char * const deviceSupportNames[106] = {
    "devAaiSoft",
    "devaaiStream",
    "devAaoSoft",
    "devaaoStream",
...
static const dset * const devsl[106] = {
...
int K2611_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/es-K2611";
    ...
    registerDevices(pbase, 106, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"K2611_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    K2611_registerRecordDeviceDriver(*iocshPpdbbase);
}
