...
/* Generated from ../O.Common/tpmac.dbd */
...
epicsShareExtern void (*pvar_func_pmacControllerRegister)(void);
...
int tpmac_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/mc12";
    ...
    (*pvar_func_pmacControllerRegister)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"tpmac_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    tpmac_registerRecordDeviceDriver(*iocshPpdbbase);
}
