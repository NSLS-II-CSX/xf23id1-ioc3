...
epicsEnvSet("PREFIX", "XF:23ID1-ES{Dif-Cam:2}")
...
prosilicaConfig("$(PORT)", "10.23.1.34", 50, 0, 0, 0, 10)
...
#dbLoadRecords("$(ADCORE)/db/NDStdArrays.template", "P=$(PREFIX),R=image1:,PORT=Image1,ADDR=0,TIMEOUT=1,TYPE=Int16,FTVL=SHORT,NELEMENTS=18163200,NDARRAY_PORT=$(PORT)")
...
dbl > /cf-update/xf23id1-ioc3.cam-dif2.dbl
