...
/* Generated from ../O.Common/zebra.dbd */
...
static const char * const deviceSupportNames[89] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[89] = {
...
epicsShareExtern void (*pvar_func_zebraRegister)(void);
...
int zebra_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/zebra";
    ...
    registerDevices(pbase, 89, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"zebra_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    zebra_registerRecordDeviceDriver(*iocshPpdbbase);
}
