...
/* Generated from ../O.Common/csx-eps.dbd */
...
int csx_eps_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/ct-eps";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"csx_eps_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    csx_eps_registerRecordDeviceDriver(*iocshPpdbbase);
}
